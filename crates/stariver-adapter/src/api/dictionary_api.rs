...
use stariver_core::infrastructure::service::dictionary::dictionary_service::{DataType, Dictionary, DictionaryEntry};
...
pub async fn add_dictionary_entry(state: web::Data<AppState>) -> impl Responder {
    ...
    let entry = DictionaryEntry::new("66".to_string(), DataType::I8, "测试".to_string()).expect("123");

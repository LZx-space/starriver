...
use starriver_identity_application::common::regex_patterns::Patterns;
use starriver_identity_domain::aggregate::user::User;
use starriver_identity_domain::aggregate::user_repository::UserRepository;
use starriver_identity_domain::aggregate::user_value_object::Email;
use starriver_identity_domain::aggregate::user_value_object::Password;
use starriver_identity_domain::aggregate::user_value_object::UserState;
use starriver_identity_domain::aggregate::user_value_object::Username;
use starriver_identity_domain::common::error::DomainError;
use starriver_identity_domain::common::error::RepositoryError;
use starriver_identity_domain::common::model::Revision;
